package com.github.axonworkflow.command;
...
public class ChatRoom {
    ...
    @CommandHandler
    public void handle(AddParticipantCommand command) {
        logger.debug("[Aggregate][Command] Handle command: {}", command);
    ...
    public void handle(RefuseParticipantCommand command) {
        ...
        AggregateLifecycle.apply(new ParticipantRefusedEvent(command.getRoomId(), command.getParticipant()));
    }
