...
import com.github.axonworkflow.saga.ApprovalStates;
...
public class AxonStateMachineWorkflowApplicationTests {
    ...
    @Autowired(required = false)
    private StateMachineService<ApprovalStates, ApprovalEvents> stateMachineService;
    ...
    public void contextLoads() {
        ...
        // assert that we indeed do not have any EventStorageEngine initialized
        assertThat(eventStorageEngine).isNull();
    }

    @Test
    public void testStateMachineService() {
        Assertions.assertThat(stateMachineService).isNotNull();
    }
}
